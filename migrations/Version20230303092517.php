 ...
 */
final class Version20230303092517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE baggiste_query ADD is_valid INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE baggiste_query DROP is_valid');
    }
}
