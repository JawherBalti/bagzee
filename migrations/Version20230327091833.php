 ...
 */
final class Version20230327091833 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE log_refund ADD refund VARCHAR(255) DEFAULT NULL, ADD transfert VARCHAR(255) DEFAULT NULL, ADD created_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE log_refund DROP refund, DROP transfert, DROP created_at');
    }
}
