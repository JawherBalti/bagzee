...
/**
 * @extends ServiceEntityRepository<PhotoClient>
 *
...
class PhotoClientRepository extends ServiceEntityRepository
{
    ...
    public function save(PhotoClient $entity, bool $flush = false): void
    {
    ...
    public function remove(PhotoClient $entity, bool $flush = false): void
    {
