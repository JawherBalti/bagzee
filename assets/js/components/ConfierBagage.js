...
class ConfierBagage extends Component {
  constructor(props) {
    super(props);
    this.state = {
      client: {},
  ...
  render() {
    ...
    return (
      <div className={"HomeSection landing confierBG"}>
        ...
        <section
          className="Header "
          style={{ backgroundImage: "url(images/headerConfierBagage.png)" }}
        >
          <div className={"row h-100 d-flex align-items-center"}>
            <div className={"col-md-8"}></div>

            <div className={"col-md-4"}>
              <p className={"dialogueHeader2 mb-4"}>
                Cherche ou dépose <br />
                une annonce
                <svg
                  ...
                  <div className={"row mb-3"}>
                    <div className={"col-lg-4"}>
                      <Link
                        ...
                        className={
                          "d-block btnConfier  w-100 btnTransparent btn-md"
                        }
                      >
                    ...
                    <div className={"col-lg-4 "}>
                      <Link
                        ...
                        style={{ fontSize: "max(60%,82%)" }}
                        className={
                          "d-block btnPorter w-100 btnTransparent btn-md"
                        }
                      >
                    ...
                    <div className={"col-lg-4"}>
                      <Link
                        ...
                        style={{ fontSize: "max(60%,82%)" }}
                        className={
                          "d-block btnDeposer w-100 btnTransparent btn-md"
                        }
                      >
                  ...
                  <div className={"row mb-3"}>
                    ...
                    <div className={"col-md-3"}>
                      <button
                        ...
                        className={"btnBlue btnRecherche reserver"}
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          width="19.016"
          ...
          <div className={"px-5 mx-0 mx-md-5"}>
            <div className={"row mb-3"}>
              <div className={"col-xl-5"}>
                ...
                <p>{t("circuit_depot_annonce.poidsMin")}</p>
                <div className={"row text-left"}>
                  <div className={"col-md-4 text-left"}>
                    <input
                      className="confier-input"
                  ...
                  this.state.annonces.map((order, key) => (
                    <ul>
                      <div className={"row "} key={"annonce-" + order.id}>
                        <div
                          className={" col-md-12 bg-white role-proprietaire"}
                        >
                          <div className={"row"}>
                            <div
                            ...
                            >
                              ...
                              >
                                ...
                                <p className={"userStatut"}>
                                  <Link
                                    to={`/mes-avis-${order.client.firstName
                                      .replace(/[^a-zA-Z0-9 ]/g, "")
                                      .replace(" ", "")}-${order.client.id}`}
                                  >
            ...
            >
              ...
              >
                ...
                >
                  <span>1</span>
                  <LazyLoadImage
                    className="etapesBagageImage"
                    src={"/images/etape1.png"}
                    alt={"etape1"}
                  />
                  <p className={"text-gris etapesBagageText"}>
                    Je crée
                    <br />
                    mon compte
                  </p>
                ...
                >
                  ...
                  <LazyLoadImage
                    className="etapesBagageImage"
                    src={"/images/etape5.png"}
                    alt={"etape1"}
                  />
                  <p className={"text-gris etapesBagageText"}>Je voyage</p>
                </li>
                <li
                  className={
                    "d-flex flex-column justify-content-start align-items-center"
...
export default withTranslation()(ConfierBagage);
