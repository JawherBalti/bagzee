...
class RecapAnnonceDemandeConfierBagage extends Component {
    ...
    soumettre() {
        ...
        axios.post(this.props.location?.state?.myReservation ? 'api/baggagite/query/create' : 'api/baggagite/query/update', {
            ...
            "baggagite_id": this.props.location?.state?.myReservation ? this.state.myReservation.id : this.state.orderId
       ...
       //console.log(Object.values(this.state.setting_price).every(val=>(val.checked==false && val.isRelais==true)))
        ...
        const onCheckboxChangeAss = (event, price) => {
            ...
            this.setState(prevState => ({
                ...
                price: value ? this.state.newprice + price : this.state.newprice - price,
                newprice: value ? this.state.newprice + price : this.state.newprice - price,
                assurancePrice: value ? this.state.assurancePrice + price : this.state.assurancePrice - price
        ...
        if (this.state.redirect) {
            return <Redirect
                to={{pathname: '/annonces', state: {role: t('proprietaire'), statusName: t('page_annonce.reservation_demande_enAttente'), status: 0}}}/>;
        } else
            return (
                loading ?
