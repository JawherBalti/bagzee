import React, {
  ...
  class RecapAnnonceDemandeConfierBagage extends Component {
    constructor(props) {
      super(props);
      this.state = {
        redirect: false,
    ...
    componentDidMount() {
      if (user) {
        axios
          .post("api/address/list", { token: user.client.token })
          .then((res) => {
            if (res.data.status) {
      ...
      if (this.props.location?.state?.myReservation) {
        ...
        this.setState(
          (prevState) => ({
            ...
            infoAvis: {
              total: this.props.location.state.myReservation.infoAvis.total,
              nbrAvis: this.props.location.state.myReservation.infoAvis.nbrAvis,
            },
        ...
        axios
          .post("api/profil/baggagistes/query/by/id", {
            ...
            this.setState(
              (prevState) => ({
                ...
                depart: {
                  ...prevState.depart,
                  nomEntreprise:
                    advert.type_adresse_depart == "Point relais" &&
                    advert.nomEntrepriseDep,
                  isPointRelais:
                    advert.type_adresse_depart == "Point relais" ? true : false,
                  isDomicile:
                    advert.type_adresse_depart == "Domicile" ? true : false,
                  isAutre:
                    advert.type_adresse_depart == "Autre lieux" ? true : false,
                  isIndifferent:
                    advert.type_adresse_depart == "Indifferent" ? true : false,
                },
                arrivee: {
                  ...prevState.arrivee,
                  nomEntreprise:
                    advert.type_adresse_arrivee == "Point relais" &&
                    advert.nomEntrepriseArr,
                  isPointRelais:
                    advert.type_adresse_arrivee == "Point relais" ? true : false,
                  isDomicile:
                    advert.type_adresse_arrivee == "Domicile" ? true : false,
                  isAutre:
                    advert.type_adresse_arrivee == "Autre lieux" ? true : false,
                  isIndifferent:
                    advert.type_adresse_arrivee == "Indifferent" ? true : false,
                },
                bagages: {
                  ...prevState.bagages,
                ...
                assurancePrice:
                  advert.porteur.price_porteur - advert.porteur.priceNet,
    ...
    soumettre() {
      ...
      axios
        .post(
          this.props.location?.state?.myReservation
            ? "api/baggagite/query/create"
            : "api/baggagite/query/update",
          {
            id: this.props.match.params.id && this.props.match.params.id,
            idPointRelaisDep: this.state.idPointRelaisDep,
            idPointRelaisArr: this.state.idPointRelaisArr,
            setting_price: this.state.setting_price,
            ...
            priceNet: this.state.newprice - this.state.assurancePrice,
            baggagite_id: this.props.location?.state?.myReservation
              ? this.state.myReservation.id
              : this.state.orderId,
          }
        )
        .then((res) => {
          Modal.success({
            content: (
              <div
                ...
                key={"onCreateAnnConf" + Math.random()}
              >
                <LazyLoadImage
                  src={
                    res.data.status
                      ? "/images/demandeSoumise.png"
                      : "/images/logo.png"
                  }
                  alt={"demande"}
                />
    ...
    render() {
      ...
      const uploadButtonPP = (
        ...
        >
          ...
          <div className="ant-upload-text text-gris">
            {t("circuit_depot_annonce.ajoutUnePhoto")}
          </div>
        </div>
      );
      ...
      const onCheckboxChangeAss = (event, price) => {
        ...
        this.setState(
          (prevState) => ({
            setting_price: prevState.setting_price.map((working) =>
              working.name === name
                ? Object.assign(working, { checked: value })
                : working
            ),
            price: value
              ? this.state.newprice + price
              : this.state.newprice - price,
            newprice: value
              ? this.state.newprice + price
              : this.state.newprice - price,
            assurancePrice: value
              ? this.state.assurancePrice + price
              : this.state.assurancePrice - price,
          }),
        ...
        return (
          <>
            ...
            {inputVisible ? (
              ...
              <Tag
                onClick={showInput}
                className="bttn gap-2 d-flex justify-content-around align-items-center"
                style={{
                  fontSize: "1rem",
                  minWidth: "max-content",
                  border: "1px solid #e8e8e8",
      ...
      const CombinerChat = ({ emailClient, orderInfo }) => {
        ...
        return (
          <div
            onClick={async () => {
              ...
              try {
                ...
                if (!res.exists()) {
                  ...
                  this.setState(
                    { myUser: myUser, orderInfo: myReservation },
                    () => {
            ...
            className={"mb-0 text-orange pointer"}
          >
            {t("btns.contacter")}
          </div>
        );
        ...
        return (
          <Redirect
            to={{
              ...
              state: {
                role: t("proprietaire"),
                statusName: t("page_annonce.reservation_demande_enAttente"),
                status: 0,
              },
            }}
          />
          ...
          <div>
            ...
            <section className={"depotAnnonce container text-center py-5"}>
                ...
                <div className={"d-flex flex-column flex-lg-row"}>
                  <div className="d-flex align-items-center justify-content-between w-100">
                    <div className={"col-md-2 text-capitalize"}>
                      ...
                      {myReservation.ville_depart}
                      <br />
                      <LazyLoadImage
                        src={
                          "/images/" +
                          myReservation.type_adresse_depart
                            .toLowerCase()
                            .replace(" ", "") +
                          ".png"
                        }
                      ...
                      >
                        <span>
                          <LazyLoadImage
                            ...
                            alt={"poids"}
                          />{" "}
                          <sub>{myReservation.dimensionsKg} Kg</sub>
                        </span>
                        <span>
                          ...
                          <sub>
                            {myReservation.dimensionsLong} x{" "}
                            {myReservation.dimensionsLarg} x{" "}
                            {myReservation.dimensionsH} Cm
                          </sub>
                        </span>
                      </div>
                    </div>
                    <div className={"col-md-2 text-capitalize mt-4 mt-md-0"}>
                      ...
                      <LazyLoadImage
                        src={
                          "/images/" +
                          myReservation.type_adresse_arrivee
                            .toLowerCase()
                            .replace(" ", "") +
                          ".png"
                        }
                  ...
                  <div className={"col-lg-3"}>
                    <p className={"fs-small mb-0 text-left"}>
                      ...
                      <span className="text-gris float-right">
                        {myReservation.dateDepart}
                      </span>
                    </p>
                    <p className={"fs-small mb-0 text-left"}>
                      {t("circuit_depot_annonce.heureDep")}
                      <span className="text-gris float-right">
                        {myReservation.heureDepart}
                      </span>
                    </p>
                    <br />
                    <p className={"fs-small mb-0 text-left"}>
                      ...
                      <span className="text-gris float-right">
                        {myReservation.dateArrivee}
                      </span>
                    </p>
                    <p className={"fs-small mb-0 text-left"}>
                      {t("circuit_depot_annonce.heureArr")}
                      <span className="text-gris float-right">
                        {myReservation.heureArrivee}
                      </span>
                    </p>
                    <br />
                  </div>
              ...
              <div className={"recapBorderedBlock text-left px-5 py-4 mt-4"}>
                <div className={"row"}>
                  <div className={"col-md-7"}>
                    <p className={"text-left"}>
                      {t("circuit_depot_annonce.contenuRefuse")}
                    </p>
                    <div
                      className={"recapBorderedBlock p-3"}
                    ...
                    >
                      ...
                      {!contenuRefuse.length && (
                        <p>
                          le porteur n'indique aucune liste des contenus refusés.
                        </p>
                      )}
                    </div>
                  </div>
                  <div className={"col-md-5 "}>
                    <p className={"text-left"}>
                      {t("circuit_depot_annonce.listeContenu")}
                    </p>
                    <div
                      className={"recapBorderedBlock p-3"}
                      style={{ borderRadius: 50 }}
                ...
                <div className={"row text-left"}>
                  <div className={"col-md-4 text-left"}>
                    <div className={"row text-left"}>
                      <p className={"col-12 text-left"}>
                        {t("circuit_depot_annonce.dimensions")}
                      </p>
                  ...
                  <div className={"col-md-4 text-left"}>
                    <div className={"row text-left"}>
                      <p className={"col-12 text-left"}>
                        {t("circuit_depot_annonce.poidsMax")}
                      </p>
                      <div className={"col-md-4  text-left"}>
                        <input
                          type={"number"}
                          ...
                          min={1}
                          placeholder={"Kg"}
                          value={this.state.bagages.dimensionsKg}
                          onChange={this.handleChangeDescBagage}
                        />
                      </div>
                    </div>
                ...
                <div className={"row text-left"}>
                  <div className={"col-md-6 text-left"}>
                    <div className={"row text-left"}>
                      ...
                      <div className="d-flex gap-3 mb-3 justify-content-center align-items-end w-100">
                        <div
                          ...
                          onClick={() => {
                            ...
                            this.setState((prev) => ({
                              depart: {
                                ...
                                isPointRelais: true,
                                placeHolderSelect: t(
                                  "circuit_depot_annonce.point_relais"
                                ),
                                isDomicile: false,
                                isAutre: false,
                                isIndifferent: false,
                          ...
                          onClick={() => {
                            this.setState((prev) => ({
                              depart: {
                                ...
                                isDomicile: true,
                                placeHolderSelect: t(
                                  "circuit_depot_annonce.domicile"
                                ),
                                isAutre: false,
                                isIndifferent: false,
                              },
                          ...
                          onClick={() => {
                            this.setState((prev) => ({
                              depart: {
                                ...
                                isAutre: true,
                                placeHolderSelect: t(
                                  "circuit_depot_annonce.autreLieu"
                                ),
                                isIndifferent: false,
                              },
                            ...
                            >
                              ...
                              >
                                <path
                                  ...
                                  fill="none"
                                  stroke={
                                    depart.isIndifferent ? "#ef7615" : "#000"
                                  }
                                  strokeWidth="1"
                                />
                                <path
                      ...
                      {depart.isIndifferent ? (
                        <div className={"col-12 text-left"}>
                          <label>{t("page_home.ville_depart_propose")}</label>
                          <input
                            type={"text"}
                            name={"ville_depart"}
                        ...
                        <Autocomplete
                          ...
                          className={
                            "d-flex flex-column flex-md-row gap-3 mb-3 justify-content-center align-items-end w-100"
                          }
                          ...
                          onChange={(e) =>
                            this.setState({
                              adresse_point_depart: e.target.value,
                            })
                          }
                        ...
                        <div className={"mx-auto"} style={{ maxWidth: 800 }}>
                          ...
                          <select
                            name={"adresse_point_depart"}
                            value={
                              depart.isPointRelais &&
                              this.state.depart.nomEntreprise
                                ? !this.state.idPointRelaisDep
                                  ? ""
                                  : this.state.depart.nomEntreprise +
                                    "-" +
                                    this.state.adresse_point_depart +
                                    "&lat=" +
                                    this.state.lat_adresse_point_depart +
                                    "&long=" +
                                    this.state.long_adresse_point_depart +
                                    "&id=" +
                                    this.state.idPointRelaisDep
                            ...
                            onChange={(e) => {
                              if (depart.isDomicile) {
                                ...
                                depart.domicile.map((res) =>
                                  res.name == e.target.value.split("&lat=")[0]
                                    ? this.setState((prev) => ({
                                        depart: {
                                          ...prev.depart,
                                        ...
                                        adresse_point_depart:
                                          e.target.value.split("&lat=")[0],
                                        lat_adresse_point_depart: myLat,
                                        long_adresse_point_depart:
                                          e.target.value.split("&long=")[1],
                                      }))
                                    : null
                                );
                              } else {
                  ...
                  <div className={"col-md-6 text-left"}>
                    <div className={"row text-left"}>
                            ...
                            >
                              ...
                              >
                                <path
                                  ...
                                  fill="none"
                                  stroke={
                                    arrivee.isIndifferent ? "#ef7615" : "#000"
                                  }
                                  strokeWidth="1"
                                />
                                <path
                      ...
                      {arrivee.isIndifferent ? (
                        <div className={"col-12 text-left"}>
                          <label>{t("page_home.ville_arrivee_propose")}</label>
                          <input
                            type={"text"}
                            name={"ville_arrivee"}
                        ...
                        <Autocomplete
                          ...
                          onChange={(e) =>
                            this.setState({
                              adresse_point_arrivee: e.target.value,
                            })
                          }
                          onPlaceSelected={(place) => {
                            place.address_components.map((res) =>
                        ...
                        <div className={"mx-auto"} style={{ maxWidth: 800 }}>
                          {arrivee.isPointRelais ? (
                            <div className={"text-left mb-2"}>
                              <label>
                                {t("page_home.ville_arrivee_propose")}
                              </label>
                              <input
                                type={"text"}
                                name={"ville_arrivee"}
                          ...
                          <select
                            name={"adresse_point_arrivee"}
                            value={
                              arrivee.isPointRelais &&
                              this.state.arrivee.nomEntreprise
                                ? !this.state.idPointRelaisArr
                                  ? ""
                                  : this.state.arrivee.nomEntreprise +
                                    "-" +
                                    this.state.adresse_point_arrivee +
                                    "&lat=" +
                                    this.state.lat_adresse_point_arrivee +
                                    "&long=" +
                                    this.state.long_adresse_point_arrivee +
                                    "&id=" +
                                    this.state.idPointRelaisArr
              ...
              <div className={"recapBorderedBlock text-left px-5 py-4 my-4"}>
                <p className={"text-left"}>
                  {t("circuit_depot_annonce.galerie")}
                </p>
              ...
              <div className={"row "}>
                    ...
                    <div className={"row m-0"}>
                      ...
                      >
                        <div className="d-flex flex-row gap-3 justify-content-start align-items-start">
                          ...
                          <p
                            className={
                              "d-flex flex-column justify-content-around align-items-center mb-0"
                            }
                          >
                      ...
                      <div
                        className={
                          "col-lg-5 d-flex justify-content-center flex-column text-center p-0"
                        }
                      >
                        <CombinerChat
                ...
                <div className={"col-md-5"}>
                  <div
                    className={
                      isDetails
                        ? "btnCustomColor mb-3 d-flex flex-column w-100 text-gris border-blue bg-transparent"
                        : "btnCustomColor text-gris border-gris bg-transparent"
                    }
                  >
                    <div
                      onClick={() => {
                        ...
                        {this.state.setting_price.map((setting) => (
                          <div className={"d-flex justify-content-between py-2"}>
                            <Checkbox
                              ...
                              onChange={(e) =>
                                onCheckboxChangeAss(e, setting.price)
                              }
                            >
                              {setting.name}
                            </Checkbox>
                            <span>
                              {setting.price ? setting.price + "€" : "_"}
                            </span>
                          </div>
                        ))}
                      </>
                  ...
                  <div
                    className={
                      "btnCustomColor mb-3 d-flex flex-row align-items-center justify-content-between w-100 text-blue border-blue bg-transparent"
                    }
                  >
                    <div>{t("circuit_depot_annonce.priceTotal")}:</div>
                    <div className={"d-flex flex-row align-items-center"}>
                      <button
                        className="btnCircleBleu"
                        onClick={() => {
                          this.state.newprice > price
                            ? this.setState({ newprice: this.state.newprice - 1 })
                            : null;
                        }}
                      >
                        -
                      ...
                      <span className="fs-3 fw-bold">
                        {this.state.newprice ? this.state.newprice : price} €
                      </span>
  
                      <button
                        className="btnCircleBleu"
                        onClick={() => {
                          this.state.newprice < 99
                            ? this.setState({ newprice: this.state.newprice + 1 })
                            : null;
                        }}
                      >
                  ...
                  <button
                    ...
                    className={"btnBlue w-100"}
                  >
                    {t("btns.soumettreDemandePorteur")}
                  </button>
                </div>
              </div>
            </section>
  ...
  export default withTranslation()(RecapAnnonceDemandeConfierBagage);
