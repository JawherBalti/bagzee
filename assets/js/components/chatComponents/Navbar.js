...
const Navbar = (props) => {
    ...
    const {data} = useContext(ChatContext);
      ...
      console.log(props)
    let avatar = ""
    if (props.orderInfo?.photo) {
        avatar = props.orderInfo.client?.photo
    } else {
        avatar = "/images/avatar-person.png"
    }
    return (
        <div className="d-flex flex-column gap-2 px-4">
            <img src={avatar} alt={props.orderInfo?.client?.firstName} style={{
                height: 50,
                width: 50,
                objectFit: 'cover',
                borderRadius: "50%",
                border: "1px solid #4dbded"}}/>
            <span>{props.orderInfo?.client?.firstName}</span>
            <span>{t('moyen_transport')}</span>
            <div className={'d-flex flex-row gap-2'}>
                {props.orderInfo?.objectTransport.includes("Voiture") ?
                ...
                {props.orderInfo?.objectTransport.includes("Car") ?
                    <svg xmlns="http://www.w3.org/2000/svg"
                ...
                {props.orderInfo?.objectTransport.includes("Camion") ?
                    <svg xmlns="http://www.w3.org/2000/svg"
                ...
                {props.orderInfo?.objectTransport.includes("Avion") ?
                    <svg xmlns="http://www.w3.org/2000/svg"
                ...
                {props.orderInfo?.objectTransport.includes("Train") ?
                    <svg xmlns="http://www.w3.org/2000/svg"
                ...
                {props.orderInfo?.objectTransport.includes("Bateau") ?
                    <svg xmlns="http://www.w3.org/2000/svg"
                ...
                {props.orderInfo?.objectTransport.includes("Indifferent") ?
                    <svg xmlns="http://www.w3.org/2000/svg"
            ...
            <span>{t('typeBienTrans')}</span>
            <span className={"text-gris"}>
                {props.orderInfo?.objectType.includes("Bagage") ?
                    <svg xmlns="http://www.w3.org/2000/svg"
                         width="17.483"
                ...
                {props.orderInfo?.objectType.includes("Sac à dos") ?
                    <svg
                ...
                {props.orderInfo?.objectType.includes("Hors format") ?
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="33.502"
                        className={"mx-1"}
                ...
                {props.orderInfo?.objectType.includes('Petits objets') ?
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="35.79"
                        className={"mx-1"}
                ...
                {props.orderInfo?.objectType.includes('Chat') ?
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="16.371"
                        className={"mx-1"}
                ...
                {props.orderInfo?.objectType.includes('Indifferent') ?
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="15.308"
                        className={"mx-1"}
            ...
            <span>{t('taille')}</span>
            <span className={"text-gris"}>{props.orderInfo?.dimensionsLong} x {props.orderInfo?.dimensionsLarg} x {props.orderInfo?.dimensionsH} Cm</span>
            <span>{t('circuit_depot_annonce.poidsMax')}</span>
            <span>{props.orderInfo?.dimensionsKg}</span>
            <span>{t('lieuDepart')}</span>
            <LazyLoadImage
                src={"/images/" + props.orderInfo?.type_adresse_depart.toLowerCase().replace(' ', '') + ".png"}
                alt={props.orderInfo?.type_adresse_depart}  width={25}/>
                <small className={"text-gris"}>{props.orderInfo?.type_adresse_depart}</small>

            <span>{t('pointLivraison')}</span>
            <LazyLoadImage
                src={"/images/" + props.orderInfo?.type_adresse_arrivee.toLowerCase().replace(' ', '') + ".png"}
                alt={props.orderInfo?.type_adresse_arrivee} width={25}/>
            <small className={"text-gris"}>{props.orderInfo?.type_adresse_arrivee}</small>
