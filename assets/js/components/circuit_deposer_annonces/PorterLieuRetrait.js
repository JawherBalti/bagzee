...
class PorterLieuRetrait extends Component {
    constructor(props) {
        super(props);
        this.state = {
            redirect: false,
        ...
        this.handleChangearrivee = this.handleChangearrivee.bind(this);
        this.handleChangeEspaceDispo = this.handleChangeEspaceDispo.bind(this);
        window.scrollTo(0, 0);
    ...
    publier(status) {
        const {arrivee, depart, espace} = this.state
        let myArr = []
        espace.isBagage && myArr.push('Bagage')
        espace.isChat && myArr.push('Chat')
        espace.isHorsFormat && myArr.push('Hors format')
        espace.isSacDos && myArr.push('Sac à dos')
        espace.isIndifferent && myArr.push('Indifferent')
        espace.isPetitObj && myArr.push('Petits objets')

        let myArr2 = []
        espace.isVoiture && myArr2.push('Voiture')
        espace.isCar && myArr2.push('Car')
        espace.isCamion && myArr2.push('Camion')
        espace.isAvion && myArr2.push('Avion')
        espace.isBateau && myArr2.push('Bateau')
        espace.isTrain && myArr2.push('Train')
        espace.isIndifferentV && myArr2.push('IndifferentV')
    ...
    render() {
        const {t} = this.props;
        const {etape, depart, arrivee, espace, contenuRefuse} = this.state;
        const Tags = () => {
            ...
            const handleClose = (removedTag) => {
                const newTags = contenuRefuse.filter((tag) => tag !== removedTag);
                console.log(newTags);
                this.setState({contenuRefuse: newTags});
            };
            const showInput = () => {
            ...
            const handleInputConfirm = () => {
                if (inputValue && contenuRefuse.indexOf(inputValue) === -1) {
                    this.setState(prev =>
                            ({
                                contenuRefuse: [...prev.contenuRefuse, inputValue
                                ]
                            })
                        , () => {
                            console.log(inputValue)
                            console.log(contenuRefuse)
                        });
                }
        ...
        {tagElem}
            ...
            const tagChild = contenuRefuse.map(forMap);
            return (
                <>
                    <div
                        style={{
                        ...
                        etape == 2 ?
                            <section className={'depotAnnonce container text-center'} >
                                ...
                                <div
                                    ...
                                    <button disabled={
                                        (arrivee.ville_arrivee == '' || arrivee.date == '' || arrivee.heure == '' || (!arrivee.isIndifferent && this.state.adresse_point_arrivee == '')) ? true : false}
                            ...
                            etape == 3 ?
                                <section className={'depotAnnonce container text-center'}>
                                    ...
                                    <div className='my-3 mx-auto' style={{maxWidth: 800}}>
                                        ...
                                        <div className='d-flex gap-3 align-items-center justify-content-start'>
                                            <div className="pointer" onClick={() => {
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="17.483" height="26.251"
                                                    ...
                                                    <path id="suitcase-svgrepo-com_1_"
                                                          ...
                                                          fill={espace.isBagage ? "#ef7615" : "#000"}/>
                                                </svg>
                                                <br/>
                                                <span className="pointer-text" style={espace.isBagage ? {
                                                    color: "#ef7615",
                                                    lineHeight: 2.5
                                                } : {
                                                    color: "#000",
                                            ...
                                            <div className="pointer" onClick={() => {
                                                this.setState(prev => ({
                                                    espace: {
                                                        ...prev.espace, isSacDos: !espace.isSacDos,
                                                    }
                                                }))
                                            }}>
                                                    ...
                                                    <g id="backpack-svgrepo-com_1_" data-name="backpack-svgrepo-com (1)"
                                                       transform="translate(-8.735)">
                                                        <path id="Tracé_6614" data-name="Tracé 6614"
                                                              ...
                                                              fill={espace.isSacDos ? "#ef7615" : "#000"}/>
                                                ...
                                                <br/>
                                                <span className="pointer-text" style={espace.isSacDos ? {
                                                    color: "#ef7615",
                                                    lineHeight: 2.5
                                                } : {
                                                    color: "#000",
                                            ...
                                            <div className="pointer" onClick={() => {
                                                this.setState(prev => ({
                                                    espace: {
                                                        ...prev.espace,
                                                        isHorsFormat: !espace.isHorsFormat,
                                                    }
                                                }))
                                            }}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="33.502" height="22.131"
                                                    ...
                                                    <g id="bike-svgrepo-com" transform="translate(0.001 -50.317)">
                                                        <path id="Tracé_6621" data-name="Tracé 6621"
                                                              ...
                                                              fill={espace.isHorsFormat ? "#ef7615" : "#000"}/>
                                                    </g>
                                                </svg>
                                                <br/>
                                                <span className="pointer-text" style={espace.isHorsFormat ? {
                                                    color: "#ef7615",
                                                    lineHeight: 2.5
                                                } : {
                                                    color: "#000",
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="35.79" height="21.048"
                                                    ...
                                                    <g id="trainers-svgrepo-com" transform="translate(0 -61.013)">
                                                        <path id="Tracé_6622" data-name="Tracé 6622"
                                                              ...
                                                              transform="translate(0)"
                                                              fill={espace.isPetitObj ? "#ef7615" : "#000"}/>
                                                    </g>
                                                </svg>

                                                <br/>
                                                <span className="pointer-text" style={espace.isPetitObj ? {
                                                    color: "#ef7615",
                                                    lineHeight: 2.5
                                                } : {
                                                    color: "#000",
                                            ...
                                            <div className="pointer" onClick={() => {
                                                this.setState(prev => ({
                                                    espace: {
                                                        ...prev.espace, isChat: !espace.isChat,
                                                    }
                                                }))
                                            }}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16.371" height="23"
                                                    ...
                                                    <path id="cat-svgrepo-com"
                                                          ...
                                                          fill={espace.isChat ? "#ef7615" : "#000"}/>
                                                </svg>

                                                <br/>
                                                <span className="pointer-text" style={espace.isChat ? {
                                                    color: "#ef7615",
                                                    lineHeight: 2.5
                                                } : {
                                                    color: "#000",
                                            ...
                                            <div className="pointer" onClick={() => {
                                                this.setState(prev => ({
                                                    espace: {
                                                        ...prev.espace,
                                                        isIndifferent: !espace.isIndifferent,
                                                    }
                                                }))
                                            }}>
                                                        ...
                                                        <g id="Groupe_8941" data-name="Groupe 8941"
                                                           transform="translate(25.906 0)">
                                                            <path id="Tracé_7680" data-name="Tracé 7680"
                                                                  ...
                                                                  fill={espace.isIndifferent ? "#ef7615" : "#000"}/>
                                                ...
                                                <br/>
                                                <span className="pointer-text" style={espace.isIndifferent ? {
                                                    color: "#ef7615",
                                                    lineHeight: 2.5
                                                } : {
                                                    color: "#000",
                                    ...
                                    <div className='my-3 mx-auto' style={{maxWidth: 800}}>
                                        <p className={'requis text-left'}>{t('circuit_depot_annonce.typeTrans')}</p>
                                        <div className='d-flex gap-3 justify-content-start'>
                                            <div className="pointer text-center" onClick={() => {
                                                this.setState(prev => ({
                                                    espace: {
                                                        ...prev.espace,
                                                        isVoiture: !espace.isVoiture,
                                                    }
                                                }))
                                            }}>
                                                       ...
                                                       transform="translate(0 0)">
                                                        <g id="Groupe_3569" data-name="Groupe 3569">
                                                            <path id="Tracé_4987" data-name="Tracé 4987"
                                                                  ...
                                                                  fill={espace.isVoiture ? "#ef7615" : "#000"}/>
                                                        ...
                                                        <g id="Groupe_4744" data-name="Groupe 4744"
                                                           transform="translate(0 83.368)">
                                                            <path id="Tracé_6610" data-name="Tracé 6610"
                                                                  ...
                                                                  transform="translate(0 -83.368)"
                                                                  fill={espace.isCar ? "#ef7615" : "#000"}/>
                                                        </g>
                                                    </g>
                                                </svg>

                                                <br/>
                                                <span style={espace.isCar ? {
                                                    color: "#ef7615",
                                                    fontSize: 12
                                                } : {
                                                    color: "#000",
                                            ...
                                            <div className="pointer text-center" onClick={() => {
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="33.884" height="17.048"
                                                    ...
                                                    <path id="truck-svgrepo-com_1_" data-name="truck-svgrepo-com (1)"
                                                          ...
                                                          fill={espace.isCamion ? "#ef7615" : "#000"}/>
                                                </svg>

                                                <br/>
                                                <span style={espace.isCamion ? {
                                                    color: "#ef7615",
                                                    fontSize: 12
                                                } : {
                                                    color: "#000",
                                                        ...
                                                        <g id="Groupe_4745" data-name="Groupe 4745"
                                                           transform="translate(0 110.089)">
                                                            <path id="Tracé_6611" data-name="Tracé 6611"
                                                                  ...
                                                                  transform="translate(0 -110.089)"
                                                                  fill={espace.isAvion ? "#ef7615" : "#000"}/>
                                                        </g>
                                                    </g>
                                                </svg>

                                                <br/>
                                                <span style={espace.isAvion ? {
                                                    color: "#ef7615",
                                                    fontSize: 12
                                                } : {
                                                    color: "#000",
                                                    ...
                                                    <g id="train-svgrepo-com_2_" data-name="train-svgrepo-com (2)"
                                                       transform="translate(0 -20.392)">
                                                        <path id="Tracé_6612" data-name="Tracé 6612"
                                                              ...
                                                              fill={espace.isTrain ? "#ef7615" : "#000"}/>
                                            ...
                                            <div className="pointer text-center" onClick={() => {
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24.57" height="20.641"
                                                    ...
                                                    <path id="boat-svgrepo-com"
                                                          ...
                                                          fill={espace.isBateau ? "#ef7615" : "#000"}/>
                                                </svg>

                                                <br/>
                                                <span style={espace.isBateau ? {
                                                    color: "#ef7615",
                                                    fontSize: 12
                                                } : {
                                                    color: "#000",
                                            ...
                                            <div className="pointer text-center" onClick={() => {
                                                this.setState(prev => ({
                                                    espace: {
                                                        ...prev.espace,
                                                        isIndifferentV: !espace.isIndifferentV,
                                                    }
                                                }))
                                            }}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="15.308" height="26.276"
                                                        ...
                                                        <g id="Groupe_8941" data-name="Groupe 8941"
                                                           transform="translate(25.906 0)">
                                                            <path id="Tracé_7680" data-name="Tracé 7680"
                                                                  d="M40.432,28.066a1.055,1.055,0,0,0-1.293.746,1,1,0,0,1-.357.6.465.465,0,0,1-.327-.037,4.868,4.868,0,0,1-2.079-1.51,4.669,4.669,0,0,0-1.047-.942,3.13,3.13,0,0,0-1.11-.521l-.677.682-.657-.689h-.007a3.088,3.088,0,0,0-1.326.688,5.639,5.639,0,0,0-.8.781,4.869,4.869,0,0,1-2.079,1.51.467.467,0,0,1-.327.037,1,1,0,0,1-.357-.6,1.056,1.056,0,0,0-2.039.548,2.951,2.951,0,0,0,1.444,1.94,2.294,2.294,0,0,0,1.04.246,2.758,2.758,0,0,0,1.009-.2,7.265,7.265,0,0,0,1.321-.671v4.1a2.13,2.13,0,0,0,.21.925c0,.012,0,.022,0,.034l-.009,10.108A1.247,1.247,0,0,0,32.2,47.085h0a1.248,1.248,0,0,0,1.247-1.247l.008-8.673c.028,0,.055,0,.083,0s.064,0,.1,0v8.673a1.248,1.248,0,1,0,2.5,0V35.73c0-.022-.005-.041-.006-.062a2.127,2.127,0,0,0,.2-.9V30.646a7.225,7.225,0,0,0,1.363.7,2.756,2.756,0,0,0,1.009.2,2.3,2.3,0,0,0,1.04-.246,2.95,2.95,0,0,0,1.444-1.94A1.056,1.056,0,0,0,40.432,28.066Zm-6.886,4.4h-.013l-.656-.9.656-4.383h.013l.656,4.383Z"
                                                                  transform="translate(-25.906 -20.81)"
                                                                  fill={espace.isIndifferentV ? "#ef7615" : "#000"}/>
                                                            <circle id="Ellipse_139" data-name="Ellipse 139" cx="2.719"
                                                                    cy="2.719"
                                                                    r="2.719" transform="translate(4.914)"
                                                                    fill={espace.isIndifferentV ? "#ef7615" : "#000"}/>
                                                ...
                                                <br/>
                                                <span style={espace.isIndifferentV ? {
                                                    color: "#ef7615",
                                                    fontSize: 12
                                                } : {
                                                    color: "#000",
                                    ...
                                    <div className={'row mx-auto'} style={{maxWidth: 800}}>
                                            ...
                                            <div className={'row text-left'}>
                                                ...
                                                <div className={'col-md-4 suffix text-left'}>
                                                    <Input type={"number"} name={"dimensionsLong"}
                                                           suffix={'Cm'} value={espace.dimensionsLong}
                                                           placeholder={t('circuit_depot_annonce.dimensionsLong')}
                                                           required
                                                           onChange={this.handleChangeEspaceDispo}/>

                                                </div>
                                                <div className={'col-md-4 suffix text-left'}>
                                                    <Input type={"number"} name={"dimensionsLarg"}
                                                           suffix={'Cm'} value={espace.dimensionsLarg}
                                        ...
                                        <div className={'col-md-12 text-left mt-4'}>
                                            <div className={'row text-left'}>
                                                <div className={'col-md-12 text-left'}>
                                                    <label>{t('circuit_depot_annonce.contenuRefuse')}</label>
                                                </div>
                                                <div className={'col-md-12 text-left'}>
                                                    <div className={"recapBorderedBlock text-left px-5 py-4"}>
                                                        <div className={'row'}>
                                    ...
                                    <div
                                        ...
                                        <button disabled={
                                            (
                                                espace.dimensionsLong == '' ||
                                                espace.dimensionsLarg == '' ||
                                                espace.dimensionsH == '' ||
                                                espace.commentaires == '' ||
                                                espace.dimensionsKg == '' ||
                                                !((espace.isBagage || espace.isSacDos || espace.isHorsFormat || espace.isPetitObj || espace.isIndifferent || espace.isChat) &&
                                                    (espace.isCar || espace.isVoiture || espace.isCamion || espace.isAvion || espace.isTrain || espace.isBateau || espace.isIndifferentV))
                                            ) ? true : false} onClick={() => {
                                            window.scrollTo(0, 0);
                                            this.setState({etape: etape + 1})
                                        }}
                                ...
                                etape == 4 ?
                                    <section className={'depotAnnonce container text-center'} >
                                                ...
                                                <div className="d-flex justify-content-between w-100">
                                                    <div className={"col-md-2 text-capitalize"}>
                                                        <svg
                                                            ...
                                                            xmlns="http://www.w3.org/2000/svg" width="27.515"
                                                            height="35.661"
                                                        ...
                                                        fontSize: 'x-small',
                                                        color: '#b9b9b9'
                                                    }}>{depart.placeHolderSelect}</sup>
                                                    </div>

                                                    <div className={'col-6 col-md-8'}>
                                                        <div
                                                            className={"d-flex flex-md-row  justify-content-center align-items-center gap-2"}>
                                                            {espace.isVoiture ?
                                                        ...
                                                        <div
                                                            ...
                                                            <span>
                                                        {espace.isBagage ?
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="17.483"
                                                                ...
                                                                <sub>{espace.dimensionsLong} x {espace.dimensionsLarg} x {espace.dimensionsH} Cm</sub>
                                                                </span>
                                                        </div>
                                                    </div>
                                                    <div className={"col-md-2 text-capitalize"}>
                                            ...
                                            <div className={'row'}>
                                                <div className={'col-md-12'}>
                                                    ...
                                                    {contenuRefuse.map(cont =>
                                                        <label className={'bttn mx-2'} style={{
                                        ...
                                        <div className={'col-md-12 text-left mt-4'}>
                                            <div className={'row text-left'}>
                                                <div className={'col-md-12 text-left'}>
                                                    <label>{t('circuit_depot_annonce.commentaires')}</label>
                                                </div>
                                                <div className={'col-md-12 text-left'}>
                                            <textarea name={"commentaires"} value={espace.commentaires}
                                                      rows={'4'}
...
export default withTranslation()(PorterLieuRetrait);