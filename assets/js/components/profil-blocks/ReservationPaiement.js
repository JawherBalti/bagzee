            ...
            <div className={"row mb-3"}>
              ...
              <div className={"col-12 pt-4 mb-4"}>
                ...
                >
                  <select
                      className={"m-0"}
                      defaultValue={this.state.filterByAssurance}
                      value={this.state.filterByAssurance}
                      style={{width: "auto", margin: "0 !important", border: "1px solid #4BBEED",}}
                      onChange={(e) => {
                        console.log(e.target.value);
                        if (e.target.value == t("stockage")) {
                          this.setState(
                              {
                                filterByAssurance:'stockage'
                              }
                          );
                        } else {
                          this.setState(
                  ...
                  >
                    <option key={"1"} value={t("stockage")}>
                      {t("stockage")}
                    </option>
                    <option key={"2"} value={t("mutuel")}>
                      {t("mutuel")}
                    </option>
                  </select>
                  <RangePicker
                ...
                {this.state.annonces ? (
                  <>
                    {this.state.filterByAssurance=='mutuel'?null:
                        <>
                    ...
                    {this.state.filterByAssurance!='mutuel'?null:<><p className={"text-uppercase mt-3"}>Contrôle mutuel</p>
                    ...
                    {this.state.filterByAssurance=='mutuel'?null:<> <p className={"text-uppercase mt-3"}>Contrôle passés</p>
