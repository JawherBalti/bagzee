...
class RecapAnnonceConfierBagage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            redirect: false,
    ...
    componentDidMount() {
        axios.get('api/relay_point/list').then(res => {
            if (res.data.status) {
                this.setState(prev => ({
                    ...
                    console.log(this.state.arrivee.pointRelais)
                    console.log(this.state.arrivee.ville_arrivee)
                })
            }
        })
        axios.get('api/payment/setting/price').then(res => {
            this.setState(prev => ({
                setting_price: res.data.setting_price
            }))
        })
        if (user) {
            this.setState({client: user.client}, () => {
                axios.post('api/card/show', {token: user.client.token}).then(res => {
        ...
        if (this.props.location.state.id) {
            ...
            if (this.props.location.state.page == 'annonce' || this.props.location.state.page =='details') {
                axios.post('api/profil/baggagistes/query/by/id', {
                    ...
                    this.setState(prevState => ({
                        ...
                        myReservation: {
                            ...
                            ville_depart: this.props.location.state.order.ville_depart,
                            ville_arrivee: this.props.location.state.order.ville_arrivee,
                            heureDepart: this.props.location.state.order.heureDepart,
                            dateDepart: this.props.location.state.order.dateDepart,
                            heureArrivee: this.props.location.state.order.heureArrivee,
                            dateArrivee: this.props.location.state.order.dateArrivee,
                            type_adresse_depart: this.props.location.state.order.type_adresse_depart,
                            type_adresse_arrivee: this.props.location.state.order.type_adresse_arrivee,
                            objectTransport: advert.objectTransport,
                            objectType: advert.objectType,
                            dimensionsLong: this.props.location.state.order.dimensionsLong,
                            dimensionsH: this.props.location.state.order.dimensionsH,
                            dimensionsKg: this.props.location.state.order.dimensionsKg,
                            dimensionsLarg: this.props.location.state.order.dimensionsLarg,
                        ...
                        console.log(this.state.listeContenu)
                    });


                })
            } else {
          /*liste demande vers recap*/
                axios.post('api/profil/adverts/query/by/id', {
                    id_order: this.props.location.state.id,
                    token: user.client.token
                }).then(res => {
                    ...
                    this.setState(prevState => ({
                        ...
                        idPointRelaisArr: advert.idPointRelaisArr,
                        listeContenu: advert.listeContenu,
                        price: this.props.location.state.clientDetails.price_porteur,
                        gellery: advert.gallery,
                        fileList: advert.gallery,
    ...
    handleChangePhotosPresentation = (e) => {
        this.setState({loadingPhoto: true, isUploaded: false});
        ...
        this.setState(({fileList: e.fileList, loadingPhoto: false}), () => {
    ...
    soumettre() {
        ...
        axios.post('api/baggagite/query/create', {
            ...
            "adresse_point_arrivee": arrivee.adresse_point_arrivee,
            "lat_adresse_point_arrivee": arrivee.lat_adresse_point_arrivee,
            "long_adresse_point_arrivee": arrivee.long_adresse_point_arrivee,
            "adresse_point_depart": depart.adresse_point_depart,
            "lat_adresse_point_depart": depart.lat_adresse_point_depart,
            "long_adresse_point_depart": depart.long_adresse_point_depart,
            ...
            "contenuRefuse": this.state.contenuRefuse,
    ...
    render() {
        ...
        if (this.state.redirectChat) {
            ...
            return <Redirect
                to={{pathname: '/annonces', state: {role: t('proprietaire'), statusName: this.props.location.state.page=="listeDemande"?t('page_annonce.ann_enCours'):t('page_annonce.reservation_demande_enAttente'), status: this.props.location.state.page=="listeDemande"?1:0}}}/>;
        } else
            return (
                loading ?
                    ...
                    <div>
                        ...
                        <section className={'depotAnnonce container text-center py-5'}>
                            ...
                            <div className={"recapBorderedBlock"}>
                                <div className={"row mx-0"}>
                                    ...
                                    <div className={'col-md-5'}>
                                        <div
                                            className={'d-flex flex-md-row flex-column justify-content-center gap-2'}>
                                    ...
                                    <div className={"col-md-2 text-capitalize mt-4 mt-md-0"}>
                            ...
                            <div className={"recapBorderedBlock text-left px-5 py-4 mt-4"}
                                ...
                                <div className={'row'}>
                                    <div className={'col-md-7'}>
                                        ...
                                        <div className={"recapBorderedBlock p-3"} style={{borderRadius: 50}}>
                                            ...
                                            {!contenuRefuse.length &&
                                            <p>le porteur n'indique aucune liste des contenus refusés.</p>}
                                        </div>
                                    </div>
                                    <div className={'col-md-5 '}>
                                ...
                                <div className={'row text-left'}>
                                    <div className={'col-md-4 text-left'}>
                                        <div className={'row text-left'}>
                                            <p className={'col-12 text-left'}>{t('circuit_depot_annonce.dimensions')}</p>
                                            <div className={'col-4 text-left px-1'}>
                                                <input type={"number"} min={1} name={"dimensionsLong"}
                                                       value={this.state.bagages.dimensionsLong}
                                                       placeholder={'Cm'}
                                                       readOnly={(this.props.location.state.page == 'listeDemande' || this.props.location.state.page =='details') ? true : false}

                                                       onChange={this.handleChangeDescBagage}/>

                                            </div>
                                            <div className={'col-4 text-left px-1'}>
                                                <input type={"number"} min={1} name={"dimensionsLarg"}
                                                       value={this.state.bagages.dimensionsLarg}
                                                       placeholder={'Cm'}
                                                       readOnly={(this.props.location.state.page == 'listeDemande' || this.props.location.state.page =='details') ? true : false}
                                            ...
                                            <div className={'col-4 text-left px-1'}>
                                                <input type={"number"} min={1} name={"dimensionsH"}
                                                       value={this.state.bagages.dimensionsH}
                                                       placeholder={'Cm'}
                                                       readOnly={this.props.location.state.page == 'listeDemande' ? true : false}
                                    ...
                                    <div className={'col-md-4 text-left'}>
                                        <div className={'row text-left'}>
                                            <p className={'col-12 text-left'}>{t('circuit_depot_annonce.poidsMax')}</p>
                                            <div className={'col-md-4  text-left'}>
                                                <input type={"number"} name={"dimensionsKg"} min={1}
                                                       placeholder={'Kg'} value={this.state.bagages.dimensionsKg}
                                                       readOnly={this.props.location.state.page == 'listeDemande' ? true : false}
                                                       onChange={this.handleChangeDescBagage}/>
                                    ...
                                    <div className={'col-md-6 text-left'}>
                                        <div className={'row text-left'}>
                                            ...
                                            {depart.isIndifferent ? <div className={'col-12 text-left'}>
                                                ...
                                                <Autocomplete
                                                    value={depart.adresse_point_depart}
                                                    className={"d-flex flex-column flex-md-row gap-3 mb-3 justify-content-center align-items-end w-100"}
                                    ...
                                    <div className={'col-md-6 text-left'}>
                                        <div className={'row text-left'}>
                                            ...
                                            {arrivee.isIndifferent ? <div className={'col-12 text-left'}>
                                                ...
                                                <Autocomplete
                                                    value={arrivee.adresse_point_arrivee}
                                                    className={"d-flex flex-column flex-md-row gap-3 mb-3 justify-content-center align-items-end w-100"}
                                                    apiKey={"AIzaSyDq2ZZeHGzuBplFDclItHIDEc-V9-Uhcm0"}
                                                    options={{
                                                        types: ["geocode", "establishment"],
                            ...
                            <div className={"row "}>
                                    ...
                                    <div className={"recapBorderedBlock p-0 mt-4"}>
                                        <div className={"row m-0"}>
                                            ...
                                            <span
                                                className={'text-orange mr-2'}>{this.state.infoAvis ? this.state.infoAvis.total : 0}</span>
                                                            <LazyLoadImage src={"/images/star.png"} alt={'avis'}
                                                                           className={'mr-2'}/>
                                                            <span
                                                                className={'text-gris'}>{this.state.infoAvis ? this.state.infoAvis.nbrAvis : 0} {t('page_avis.avis')}</span>
                                                        </div>
                                                    </p>
                                            ...
                                            <div
                                                ...
                                                <div className={"mb-0 text-gris pointer"}>{t('btns.signaler')}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className={"col-md-5"}>
                                    <div
                                        className={isDetails ? "btnCustomColor mb-3 d-flex flex-column w-100 text-gris border-blue bg-transparent" : "btnCustomColor text-gris border-gris bg-transparent"}>
                                        <div onClick={() => {
                                            this.setState({isDetails: !isDetails})
                                        }} className={'d-flex justify-content-between py-2'}>
                                            <span>{t('btns.details')}</span>
                                            <FontAwesomeIcon icon={isDetails ? faChevronUp : faChevronDown}/>
                                        </div>
                                        {isDetails ?
                                            <>
                                                <>
                                                    ...
                                                    {this.props.location.state.page == 'annonce' || this.props.location.state.page =='details' ? this.state.setting_price.map(setting =>
                                                        ...
                                                        :
                                                        this.props.location.state.clientDetails.setting_price.filter(val => val.isRelais == false).map(setting =>
                                                            <div className={'d-flex justify-content-between py-2'}>
                                                                <Checkbox className={'text-gris'} name={setting.name}
                                                                          style={{pointerEvents: 'none'}}
                                                                          checked={setting.checked}
                                                    ...
                                                    {this.props.location.state.page == 'annonce' || this.props.location.state.page =='details' ? null : myReservation.client.objectRelaisArriv.filter(val => val.isRelais == true && val.checked == true).map(setting =>
                                                        <div className={'d-flex justify-content-between py-2'}>
                                                            <Checkbox className={'text-gris'} name={setting.name}
                                                                      style={{pointerEvents: 'none'}}
                                                                      checked={setting.checked}
                                                    ...
                                                    {this.props.location.state.page == 'annonce' || this.props.location.state.page =='details' ? null : myReservation.client.objectRelaisDepart.filter(val => val.isRelais == true && val.checked == true).map(setting =>
                                                        <div className={'d-flex justify-content-between py-2'}>
                                                            <Checkbox className={'text-gris'} name={setting.name}
                                                                      style={{pointerEvents: 'none'}}
                                                                      checked={setting.checked}
                                    ...
                                    {this.props.location.state.page == "details" ? null :
                                        <button disabled={this.state.disabled ? true : false}
                                                onClick={() => this.setState({showModalRecap: true})}
                                                className={"btnBlue w-100"}>{t('reserve')} {this.state.disabled ? <span
                                            className="fa fa-spin fa-spinner "></span> : null}</button>}
                                </div>
                            </div>
                        </section>
                        <Modal open={this.state.showModalRecap}
                               onCancel={() => this.setState({showModalRecap: false})}
                               className={'recapCmd'}
                               footer={
                                   [
                                       <Button
                                           className='btnCustomColor text-blue bg-transparent border-blue py-0 fs-2'>{this.state.newprice ? this.state.newprice : price} €</Button>,
                                       <Button className={'btnBlue myBtn mx-auto'}
                                               disabled={(this.state.agreement) ? false : true} onClick={() => {
                                           if (this.state.paiement.length == 0) {
                                               Modal.success({
                                                   className: 'payment',
                                                   content: (
                                                       <div className={"text-center"}
                                                            key={'reservation-modal-' + Math.random()}>
                                                           <div>
                                                               ...
                                                               <p style={{color: '#8D8D8D'}}
                                                                  className={"pt-2"}>
                                                                   Veuillez ajouter une carte bancaire
                                                               </p>
                                                           </div>
                                                       </div>),
                                                   okText: 'ok',
                                               ...
                                               this.setState({showModalRecap: false, disabled: true})
                                               let myData = {
                                                   "isBagagiste": this.props.location.state.page == "annonce" ? true : false,
                                                   "total": this.state.price - this.state.reduceCodePromo,
                                                   ...
                                                   "reduce": this.state.reduceCodePromo,
                                                   "payment_method": null,
                                               }

                                               try {
                                                   axios.post(`api/payment/create`, myData).then(response => {
                                                       if (response.data.requires_action) {
                                                           strip.handleCardAction(
                                                               ...
                                                               if (result.error) {
                                                                           ...
                                                                           <div className={"text-center"}
                                                                               ...
                                                                               <div>
                                                                                   <FontAwesomeIcon icon={faTimes}
                                                                                                    ...
                                                                                                    color={'red'}/>
                                                                                   <p style={{color: '#8D8D8D'}}
                                                                                      className={"pt-2"}>Votre paiement
                                                                                       à
                                                                                       échoué.
                                                                                       🥺
                                                                                       <br/>
                                                                                       Veuillez vous rapprocher de votre
                                                                                       banque
                                                                                   </p>
                                                                               </div>
                                                                           </div>),
                                                                   ...
                                                                   axios.post('api/payment/create', myData
                                                                   ).then(response => {
                                                                       Modal.success({
                                                                           className: 'payment',
                                                                           content: (
                                                                               <div className={"text-center"}
                                                                                    key={'acti-' + Math.random()}>
                                                                                   {(response.data.status == false) ?
                                                                                       <div>
                                                                                           <FontAwesomeIcon
                                                                                               ...
                                                                                               color={'red'}/>
                                                                                           <p style={{color: '#8D8D8D'}}
                                                                                              className={"pt-2"}>{response.data.message}
                                                                                           </p>
                                                                                       </div>
                                                                                       :
                                                                                       <div>
                        ...
                        >
                            <div className={"container"}>
                                <label className={'text-center fs-5 w-100 text-blue mb-3'}>{t('recap.recapCmd')}</label>
                                <div className="row">
                                    <div className="col-md-12 text-center">
                                        <div
                                            ...
                                            <div
                                                className={'d-flex flex-column justify-content-around align-items-center mb-0'}>
                                                <span>{myReservation.client.firstName}</span>
                                                <div>
                                            <span
                                                className={'text-orange mr-2'}>{this.state.infoAvis ? this.state.infoAvis.total : 0}</span>
                                        ...
                                        <div className={"row"}>
                                            ...
                                            <div className={'col-md-6'}>
                                                ...
                                                <div
                                                    className={'d-flex flex-md-row flex-column align-items-center justify-content-between h-100'}>
                                                                <span>
                                                                    <LazyLoadImage src={"/images/poids.png"}
                                                                                   alt={'poids'}/> <sub>{myReservation.dimensionsKg} Kg</sub>
                                                                </span>
                                                ...
                                                <>
                                                    {myReservation.client ?
                                                        <>
                                                            ...
                                                            {this.props.location.state.page == 'annonce' || this.props.location.state.page =='details' ?
                                                                ...
                                                                :
                                                                this.state.setting_price.filter(val => val.isRelais == false).map(setting =>
                                                                    <div
                                                                        className={'d-flex justify-content-between py-2'}>
                                                                        <Checkbox className={'text-gris'}
                                                                                  name={setting.name}
                                                            ...
                                                            {this.props.location.state.page == 'annonce' || this.props.location.state.page =='details' ? null :
                                                                myReservation.client.objectRelaisArriv.filter(val => val.isRelais == true && val.checked == true).map(setting =>
                                                                    <div
                                                                        className={'d-flex justify-content-between py-2'}>
                                                                        <Checkbox className={'text-gris'}
                                                                                  name={setting.name}
                                        ...
                                        <label className="text-gris m-0 text-uppercase">{t('recap.codepromo')}</label>
                                        <Input.Group className={'my-2'} compact>
                                            <Input
                                                prefix={<LazyLoadImage
                                                    src={'/images/codePromo.png'}
                                                    alt={'code promo'}/>}
                                                placeholder={'Ajouter ton code promo'}
                                                style={{
                                                    width: '60%',
                                                ...
                                                onChange={(e) => this.setState({codePromos: e.target.value})}/>
                                            <Button type="primary" onClick={() => {
                                                axios.post('api/sponsorship/check', {
                                                    ...
                                                    let price = 0
                                                    let reduceCodePromo = 0
                                                    if (res.data.status) {
                                                        if (res.data.codePromos.type == "montant") {
                                                            price = this.state.price - res.data.codePromos.reduce
                                                            reduceCodePromo = res.data.codePromos.reduce
                                                        } else {
                                                            price = (this.state.price * ((100 - res.data.codePromos.reduce) / 100))
                                                            reduceCodePromo = this.state.price - price
                                                        }
                                                        this.setState({
                                                            newprice: price,
                                                            reduceCodePromo: reduceCodePromo,
                                            ...
                                            <span style={{
                                                width: '10%',
                                                lineHeight: '40px'
                                            }}>{this.state.reduceCodePromo ? this.state.reduceCodePromo + '€' : null}</span>
                                        </Input.Group>
                                        <Checkbox onChange={(e) => {
...
export default withTranslation()(RecapAnnonceConfierBagage);